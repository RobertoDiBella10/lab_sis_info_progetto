...
class TableClothes extends StatefulWidget {
  TableClothes(
  ...
  @override
  State<TableClothes> createState() => _TableClothesState();
}

class _TableClothesState extends State<TableClothes> {
  ...
  void _trySubmit(bool function) async {
    ...
    if (isValid) {
      ...
      if (function) {
        Vestito()
            .addQuantityClothes(_selectedRowKeys, _quantita, context)
            .then((value) {
          if (value) {
        ...
        Vestito().deleteQuantity(_selectedRowKeys.first, _quantita, context);
      }
    }
  }
            ...
            WebDataTable(
              ...
              source: WebDataTableSource(
                columns: [
                  ...
                  WebDataColumn(
                    name: 'taglia',
                    label: const Text('Taglia'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'fasciaEta',
                    label: const Text('Fascia Età'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'confezione',
                    label: const Text('Confezione'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                ],
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              Vestito()
                                  .deleteClothes(_selectedRowKeys, context);
                              setState(() {
                                _selectedRowKeys.clear();
                              });
                            },
