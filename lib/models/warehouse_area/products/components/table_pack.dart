...
class _TablePackState extends State<TablePack> {
  ...
  void _trySubmit(bool function) async {
    ...
    if (isValid) {
      ...
      if (function) {
        Confezione()
            .addQuantityPack(_selectedRowKeys, _quantita, context)
            .then((value) {
          if (value) {
        ...
        Confezione().deleteQuantity(_selectedRowKeys.first, _quantita, context);
      }
    }
  }
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              Confezione()
                                  .deletePack(_selectedRowKeys, context);
                              setState(() {
                                _selectedRowKeys.clear();
                              });
                            },
