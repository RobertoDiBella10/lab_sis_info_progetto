...
import '../../provider_order/add/add_order.dart';
            ...
            WebDataTable(
              ...
              actions: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Fornitore()
                            .getTypeProduct(_selectedRowKeys.first, context)
                            .then((value) {
                          setState(() {
                            isLoading = false;
                          });
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => Order(
                                        provider: _selectedRowKeys.first,
                                        filter: const [],
                                        pageNumber: 0,
                                        pageSize: 10,
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      widget.search = value;
                      Fornitore().searchProviders(value, context);
                    },
                  ),
                ),
              ],
              source: WebDataTableSource(
                ...
                columns: [
                  WebDataColumn(
                    name: 'piva',
                    label: const Text('Partita IVA'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'regione',
                    label: const Text('Regione'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'citta',
                  ...
                  WebDataColumn(
                    ...
                    label: const Text('Ragione sociale'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'tipologia_prodotto',
                    label: const Text('Tipologia prodotto'),
                    dataCell: (value) => DataCell(Text('$value')),
                    sortable: false,
                  ),
                  WebDataColumn(
                    name: 'cellulare',
                    label: const Text('Cellulare'),
                    dataCell: (value) => DataCell(Text('$value')),
                    sortable: false,
                  ),
                  WebDataColumn(
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              Fornitore()
                                  .deleteProviders(_selectedRowKeys, context);
                              setState(() {
