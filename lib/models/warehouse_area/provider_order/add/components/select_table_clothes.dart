...
class TableSelectClothes extends StatefulWidget {
  TableSelectClothes(
  ...
  @override
  State<TableSelectClothes> createState() => _TableSelectClothesState();
}

class _TableSelectClothesState extends State<TableSelectClothes> {
  ...
  void _trySubmit() async {
    ...
    if (isValid) {
      ...
      widget.function(
          _selectedRowKeys.first, _quantita, _price);
