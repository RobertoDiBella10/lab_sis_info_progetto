...
import 'package:lab_sis_info_progetto/data/providers_order.dart';
            ...
            WebDataTable(
              ...
              source: WebDataTableSource(
                ...
                columns: [
                  ...
                  WebDataColumn(
                    name: 'data',
                    label: const Text('Data Creazione'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'piva',
                    label: const Text('Partita IVA Fornitore'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'totale',
                  ...
                  WebDataColumn(
                    ...
                    label: const Text('Codice Fiscale Titolare'),
                    dataCell: (value) => DataCell(Text('$value')),
                  ),
                  WebDataColumn(
                    name: 'dataConsegna',
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              OrdineFornitore().deleteProvidersOrders(
